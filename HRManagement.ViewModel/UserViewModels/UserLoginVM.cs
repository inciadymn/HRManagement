...
namespace HRManagement.ViewModel.UserViewModels
{
    public class UserLoginVM
    {
        ...
        [StringLength(100, ErrorMessage = "Min 10, max 100 karakter girilebilir...", MinimumLength = 10)]
        [Required(ErrorMessage = "Email zorunlu...")]
        public string Email { get; set; }

        [DataType(DataType.Password)]
        [Display(Name = "Password", Prompt = "password")]
        [StringLength(20, ErrorMessage = "Min 3, max 20 karakter girilebilir...", MinimumLength = 3)]
