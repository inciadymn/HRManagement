...
namespace HRManagement.DAL.Migrations
{
    ...
    [Migration("20220323175158_permission")]
            ...
            modelBuilder.Entity("HRManagement.Model.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Address = "İstanbul",
                            BirthDay = new DateTime(2022, 3, 23, 20, 51, 58, 299, DateTimeKind.Local).AddTicks(442),
                            ...
                            Photo = "...",
                            StartDate = new DateTime(2022, 3, 23, 20, 51, 58, 300, DateTimeKind.Local).AddTicks(2554)
                        });
                });
