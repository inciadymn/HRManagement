...
namespace HRManagement.DAL.Migrations
{
    ...
    [Migration("20220323180329_permissionV1")]
    partial class permissionV1
    {
            ...
            modelBuilder.Entity("HRManagement.Model.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Address = "İstanbul",
                            BirthDay = new DateTime(2022, 3, 23, 21, 3, 29, 315, DateTimeKind.Local).AddTicks(358),
                            ...
                            Photo = "...",
                            StartDate = new DateTime(2022, 3, 23, 21, 3, 29, 316, DateTimeKind.Local).AddTicks(9002)
                        });
                });
